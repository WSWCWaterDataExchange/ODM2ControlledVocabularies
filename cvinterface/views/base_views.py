...
from cvservices.models import ControlledVocabularyRequest, Units
...
class DefaultRequestUpdateView(SuccessMessageMixin, UpdateView):
    ...
    def form_valid(self, form):
        email_subject = 'WADE Controlled Vocabularies - Submission Update'
...
class DefaultRequestCreateView(SuccessMessageMixin, CreateView):
    ...
    'We will notify you of our decision to include your term as soon as posible. Thank you.'
    ...
    def send_confirmation_email(self, form):
        ...
        submitter_email_subject = 'WaDE Controlled Vocabularies Submission'
        submitter_email_message = ''.join(['Thank you for your submission to WaDE Controlled Vocabularies.', linesep, linesep,
        ...
        admins_email_subject = 'New request for an WaDE Controlled Vocabulary Term'
